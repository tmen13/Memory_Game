    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItem(position).getTipo() != JogoActivity.SINGLEPLAYER) {
            ...
            if (getItem(position).getMode() == JogoActivity.SERVER) {
                ...
                tentativasJogador1TextView.setText("Tentativas: " + getItem(position).getTentativas(JogoActivity.OTHER));
                tentativasJogador2TextView.setText("Tentativas: " + getItem(position).getTentativas(JogoActivity.ME));
                acertadasJogador1TextView.setText("Acertadas: " + getItem(position).getAcertadas(JogoActivity.OTHER));
                acertadasJogador2TextView.setText("Acertadas: " + getItem(position).getAcertadas(JogoActivity.ME));
                intrusosAcertadosJogador1TextView.setText("Intrusos Acertados: " + getItem(position).getIntrusosAcertados(JogoActivity.OTHER));
                intrusosAcertadosJogador2TextView.setText("Intrusos Acertados: " + getItem(position).getIntrusosAcertados(JogoActivity.ME));
